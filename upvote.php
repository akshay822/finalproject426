<?php
  ...
  $query = "select * from upvotes where username = '".$username."' and place_id = '".$place_id."'";
  $result = $conn->query($query);


  if($result->num_rows == 0){
    $query = "insert into upvotes(username, place_id) values ('".$username."', '".$place_id."')";
    $result = $conn->query($query);

    $query2 = "delete from downvotes where username = '".$username."' and place_id = '".$place_id."'";
